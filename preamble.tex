...
\newcommand{\prho}[1][\rho]{#1_{\mathrm{triv}}}
%\newcommand{\pchi}[1][\chi]{#1_{\mathrm{triv}}}
\newcommand{\pchi}[1][\chi]{{#1}_{\mathrm{triv}}}
\newcommand{\rchi}[1][\chi]{#1_{\mathrm{reg}}}
\newcommand{\rrho}[1][\rho]{#1_{\mathrm{reg}}}
\DeclareMathOperator{\Cl}{\mathscr C}
